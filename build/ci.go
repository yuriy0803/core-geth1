...
import (
	...
	"github.com/yuriy0803/core-geth1/crypto/signify"
	"github.com/yuriy0803/core-geth1/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/yuriy0803/core-geth1/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/yuriy0803/core-geth1/internal/version.gitDate="+env.Date)
	}
